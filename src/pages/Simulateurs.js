...
import {Result,Spin,Icon, Breadcrumb } from 'antd';
import { NavLink } from 'react-router-dom';

import HeadLayout from './../containers/Layout';

class Simulateurs extends React.Component {
  state = {
    current: 'mail',
  };
    ...
    return (
      <HeadLayout>
        <Breadcrumb style={{ margin: '16px 0' }}>
              ...
              <Breadcrumb.Item><NavLink exact to='/simulateurs'>Simulateurs</NavLink></Breadcrumb.Item>
        </Breadcrumb>
