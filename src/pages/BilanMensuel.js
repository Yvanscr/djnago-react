...
import { Breadcrumb,Spin,Result,Icon } from 'antd';
import { NavLink } from 'react-router-dom';

import HeadLayout from './../containers/Layout';

class BilanMensuel extends React.Component {
    ...
    return (
      <HeadLayout>
        <Breadcrumb style={{ margin: '16px 0' }}>
              ...
              <Breadcrumb.Item><NavLink exact to='/mensuel'>Mensuelle</NavLink></Breadcrumb.Item>
        </Breadcrumb>
